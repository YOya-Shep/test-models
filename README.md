## Исследование моделей на сгенерированных данных
...
Примечание: 01.08.2026 сюда была добавлена папка [ipynb_files](https://github.com/YOya-Shep/test-models/tree/main/ipynb_files). использовать ipynb файлы с возможностью быстрого вывода является более стандартным и правильным решением при создании моделей, но ранее мне было лень обновлять jupyter notebook
